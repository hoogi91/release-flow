<?php
namespace Hoogi91\ReleaseFlow\Test\Version;

use Hoogi91\ReleaseFlow\Version\ComposerFile;
...
/**
 * Tests the ComposerFileProvider
 * 
 */
class ComposerFileProviderTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetCurrentVersion()
    {
        ...
        $this->assertInstanceOf("\Hoogi91\ReleaseFlow\Version", $actual);
    ...
    {
        $this->assertEquals('hoogi91/composer-test-package', $this->file->getProjectName());
    }
